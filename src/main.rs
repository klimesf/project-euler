...
fn main() {
    ...
    if args.contains(&"all".to_string()) || args.contains(&"e52".to_string()) {
        println!("{}", format!("--- 52:").underline().green());
        measure!(e52());
    }

    if args.contains(&"all".to_string()) || args.contains(&"e53".to_string()) {
        println!("{}", format!("--- 53:").underline().green());
        measure!(e53());
    }
    ...
    if args.contains(&"all".to_string()) || args.contains(&"e57".to_string()) {
        println!("{}", format!("--- 57:").underline().green());
        measure!(e57());
    }
    ...
    if args.contains(&"all".to_string()) || args.contains(&"e63".to_string()) {
        println!("{}", format!("--- 63:").underline().green());
        measure!(e63());
    }
    ...
    if args.contains(&"all".to_string()) || args.contains(&"e684".to_string()) {
        println!("{}", format!("--- 684:").underline().green());
        measure!(e684());
    }

    // if args.contains(&"all".to_string()) || args.contains(&"e816".to_string()) {
    //     println!("{}", format!("--- 816:").underline().green());
    //     measure!(e816());
    // }
